...
final class PreviewPhotoGridView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        layer.cornerRadius = MyMessagesPreviewMetrics.photoCornerRadius
        clipsToBounds = true
        backgroundColor = MyMessagesPreviewMetrics.photoPlaceholderColor
    ...
    func configure(imageUrls: [String]) {
        ...
        while index < imageUrls.count {
            ...
            rowStack.snp.makeConstraints {
                $0.height.equalTo(MyMessagesPreviewMetrics.photoRowHeight)
            }
            ...
            for offset in index..<end {
                ...
                imageView.backgroundColor = MyMessagesPreviewMetrics.photoPlaceholderColor
