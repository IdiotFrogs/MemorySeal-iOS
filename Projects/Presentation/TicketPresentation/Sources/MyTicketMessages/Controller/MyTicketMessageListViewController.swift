...
// MARK: - MyTicketMessageListViewController

public final class MyTicketMessageListViewController: UIViewController {

    // MARK: - Properties

    private let viewModel: MyTicketMessagesViewModel
    private let type: MyTicketMessageType
    ...
    public init(type: MyTicketMessageType, viewModel: MyTicketMessagesViewModel) {
        self.type = type
...
extension MyTicketMessageListViewController: UICollectionViewDelegate {
...
extension MyTicketMessageListViewController: UICollectionViewDataSource {
