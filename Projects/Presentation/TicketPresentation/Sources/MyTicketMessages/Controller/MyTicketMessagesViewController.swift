...
// MARK: - MyTicketMessagesTab

enum MyTicketMessagesTab: Int, CaseIterable {
    case text
    case photo
    ...
    var messageType: MyTicketMessageType {
        switch self {
...
// MARK: - MyTicketMessagesViewController

public final class MyTicketMessagesViewController: TabmanViewController {

    // MARK: - Properties

    private let viewModel: MyTicketMessagesViewModel
    ...
    public init(
        ...
        with viewModel: MyTicketMessagesViewModel
    ) {
...
extension MyTicketMessagesViewController {
    ...
    private func configureChildSelectionMode() {
        for child in listViewControllers {
            guard let listVC = child as? MyTicketMessageListViewController else { continue }
...
extension MyTicketMessagesViewController {
    private func bindButton() {
        ...
        floatingButton.rx.tap
            ...
            .subscribe(onNext: { (self, _) in
                ...
                guard let tab = MyTicketMessagesTab(rawValue: index) else { return }
                switch tab {
                case .text:
    ...
    private func handleTrashButtonTap() {
        ...
        guard index < listViewControllers.count,
              let listVC = listViewControllers[index] as? MyTicketMessageListViewController
        else { return }
...
extension MyTicketMessagesViewController: PHPickerViewControllerDelegate {
...
extension MyTicketMessagesViewController: TMBarDataSource {
    public func barItem(
        for bar: any Tabman.TMBar,
        at index: Int
    ) -> any Tabman.TMBarItemable {
        return TMBarItem(title: MyTicketMessagesTab(rawValue: index)?.title ?? "")
    }
}

// MARK: - PageboyViewControllerDataSource

extension MyTicketMessagesViewController: PageboyViewControllerDataSource {
    ...
    public func defaultPage(
        ...
        return .at(index: MyTicketMessagesTab.text.rawValue)
    }
}
